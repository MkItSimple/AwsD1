...
public class RecyclerViewwAdapter extends RecyclerView.Adapter<RecyclerViewwAdapter.MyViewHolder> {

    Context mContext;
    List<Contact> mData;
    Dialog myDialog;

    public RecyclerViewwAdapter(Context mContext, List<Contact> mData) {
